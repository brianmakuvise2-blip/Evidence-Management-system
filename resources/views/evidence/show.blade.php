...
<div class="container-fluid">
    ...
    <div class="row align-items-center mb-4">
        ...
        <div class="col-auto">
            @if(!$evidence->trashed())
                @if($evidence->status !== 'verified' && Auth::user()->hasAnyRole('evidence-officer', 'administrator', 'system-administrator', 'super-admin', 'rbz-system-admin', 'zacc-system-admin', 'npa-system-admin', 'zrp-system-admin', 'judicial-system-admin'))
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            {{-- Quick Actions Card --}}
            @if(Auth::user()->hasAnyRole('super-admin','administrator','system-administrator','rbz-system-admin','zacc-system-admin','npa-system-admin','zrp-system-admin','judicial-system-admin','judicial-courts-admin') && !$evidence->trashed())
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-light">
                        <h5 class="card-title mb-0">
