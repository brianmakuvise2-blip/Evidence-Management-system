...
<head>
    ...
    <title>Server Error — EvidenceEMS</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .icon-wrap {
            ...
            margin: 0 auto 1.75rem; font-size: 2.25rem; color: #dc2626;
        }
        ...
        p { color: var(--gray-500); font-size: 0.9375rem; line-height: 1.65; margin-bottom: 0.5rem; }
        .hint {
            background: var(--gray-50); border: 1px solid var(--gray-200);
            border-radius: 0.5rem; padding: 0.875rem 1rem;
            font-size: 0.875rem; color: var(--gray-500); margin: 1.25rem 0 2rem; text-align: left;
        }
...
<body>
    ...
    <div class="page">
        <div class="card">
            ...
            <div class="error-code">Error 500 &mdash; Server Error</div>
            <h1>Something went wrong on our end</h1>
            <p>An unexpected error occurred while processing your request. This has been logged and our team will look into it.</p>
            <div class="hint">
                <i class="bi bi-info-circle"></i>
                Please try again in a few moments. If the problem persists, contact your system administrator with the approximate time this occurred.
            </div>
            <div class="actions">
